...
{
  public String mActivityName = "HistoryActivity";
  ...
  protected void onCreate(Bundle savedInstanceState)
  {
    ...
    mTestIndex = intent.getIntExtra(EXTRA_TEST_ID, 0);
    ...
    if (actionBar != null) {
      if (mTestIndex != 0)
        actionBar.setSubtitle("Test " + mTestIndex);
  ...
  private ArrayList<HistoryListEntry> getDataSet()
  {
    ...
    if (mTestIndex != 0) {
      ...
      selectionArgs = new String[] { Integer.toString(mTestIndex) };
    }
