...
public class SaveResultDialog extends AppCompatDialogFragment
     ...
     */
    public static SaveResultDialog newInstance(int index) {
        SaveResultDialog fragment = new SaveResultDialog();
     ...
     */
    public static SaveResultDialog newInstance(Helper.Groups group) {
        SaveResultDialog fragment = new SaveResultDialog();
        Bundle args = new Bundle();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.dialog_test_options_title)
                ...
                .setMessage(R.string.dialog_save_result)
