...
public class DatabaseManagerActivity extends Activity implements OnItemClickListener {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    submitQuery.setOnClickListener(new OnClickListener() {
      ...
      @Override public void onClick(View v) {
        ...
        if (Message2.getString(0).equalsIgnoreCase("Success")) {
          ...
          if (c4 != null) {
            tvmessage.setText(
                "Query Executed successfully.Number of rows returned :" + c4.getCount());
            if (c4.getCount() > 0) {
    ...
    Timber.d("Message from sql = %s", msg);
    ...
    ArrayAdapter<String> tablenamesadapter =
        new ArrayAdapter<String>(DatabaseManagerActivity.this, android.R.layout.simple_spinner_item,
            tablenames) {
    ...
    select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
      ...
      @Override public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
        ...
        if (pos != 0) {
          ...
          Timber.d("selected table name is %s", c.getString(0));
            ...
            spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
              @Override public void onItemSelected(AdapterView<?> parentView, View selectedItemView,
                  ...
                  runOnUiThread(new Runnable() {
                    @Override public void run() {
                      ...
                      if (!isFinishing()) {
                        ...
                        new AlertDialog.Builder(DatabaseManagerActivity.this).setTitle(
                            "Are you sure ?")
                ...
                if (spinnertable.getSelectedItem()
                    .toString()
                    .equals("Delete this table")) {    // an alert dialog to confirm user selection
                  runOnUiThread(new Runnable() {
                    @Override public void run() {
                            ...
                            .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                              ...
                              public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (tempc.getString(0).equalsIgnoreCase("Success")) {
                                  tvmessage.setBackgroundColor(Color.parseColor("#2ecc71"));
                                  tvmessage.setText(
                                      indexInfo.table_name + " table content deleted successfully");
                ...
                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                  ...
                  final RelativeLayout addnewlayout =
                      new RelativeLayout(DatabaseManagerActivity.this);
                  ...
                  for (int i = 0; i < addnewrownames.size(); i++) {
                    ...
                    Timber.d("Edit Text Value = %s", et.getText().toString());
                            ...
                            .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                              ...
                              public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (tempc.getString(0).equalsIgnoreCase("Success")) {
                                  tvmessage.setBackgroundColor(Color.parseColor("#2ecc71"));
                                  tvmessage.setText(
                                      "New Row added succesfully to " + indexInfo.table_name);
                                  refreshTable(0);
                                } else {
                                  tvmessage.setBackgroundColor(Color.parseColor("#e74c3c"));
                                  tvmessage.setText("Error:" + tempc.getString(0));
  ...
  public void updateDeletePopup(int row) {
    ...
    ArrayAdapter<String> crudadapter =
        new ArrayAdapter<String>(DatabaseManagerActivity.this, android.R.layout.simple_spinner_item,
            spinnerArray) {
    ...
    for (int i = 0; i < columnames.size(); i++) {
      ...
      et.setTextColor(Color.parseColor("#000000"));
      et.setId(k);
      Timber.d("text View Value = %s", tv.getText().toString());
      final LinearLayout ll = new LinearLayout(DatabaseManagerActivity.this);
    ...
    previous.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        if (indexInfo.currentpage == 1) {
          Toast.makeText(getApplicationContext(), "This is the first page", Toast.LENGTH_LONG)
              .show();
        } else {
          ...
          Timber.d("index = %d", indexInfo.index);
        }
      }
    });
    ...
    next.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        if (indexInfo.currentpage >= indexInfo.numberofpages) {
          Toast.makeText(getApplicationContext(), "This is the last page", Toast.LENGTH_LONG)
              .show();
        } else {
          indexInfo.currentpage = indexInfo.currentpage + 1;
          boolean decider = true;
